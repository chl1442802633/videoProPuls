...
<head>
    ...
    <script type="text/javascript">
          ...
          function yanzheng() {
                ...
                $.post("${pageContext.request.contextPath}/user/validateEmailCode",{"code":code},function (data) {
                    if(data === "success") {
                      location.href =  "${pageContext.request.contextPath}/user/reset?email="+email ;
                    }else {
    ...
    <main>
        <div class="container">
            <form class="ma" >
                ...
                <div class="form_body">
                    <input type="email" placeholder="请输入登录邮箱"  id="email" name="email" onblur="getUserEmail()">
                    <input type="text" placeholder="请输入验证码" name="code" id="code"><input type="button" id="yzmBtn" value="获取验证码"/>
                    <span id="tishi"></span>
                    <input type="submit"  onclick=" return yanzheng()" value="提交";>
