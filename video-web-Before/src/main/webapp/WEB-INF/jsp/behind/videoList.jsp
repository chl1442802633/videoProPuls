		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<form class="navbar-form navbar-right" action="${pageContext.request.contextPath}/video/list" method="post" >
					<input type="text" name="courseTitle" class="form-control" placeholder="标题">
					<div class="btn-group">
				...
				<tbody>
					<c:forEach items="${pageInfo.list}" var="video" varStatus="status">
						<tr>
							...
							<td>${video.time}</td>
							<td>${video.playNum}</td>
							<td><a href="edit?id=${video.id}"><span
	...
	<div class="container">
		<div class="navbar-right">
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<li>
						<a href="${pageContext.request.contextPath}/video/list?page=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
					<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum" >
						<li><a href="${pageContext.request.contextPath}/video/list?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
					</c:forEach>


					<li>
						<a href="${pageContext.request.contextPath}/video/list?page=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">
